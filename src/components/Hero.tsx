  ...
  return (
    <>
      <div className="bg-gray-950 flex justify-center text-center p-4 w-full">
        <h2 className="text-2xl bg-[#d2d2d2] text-black px-4 py-2 w-2/3 font-medium">NICHOLAS EIKENBERG</h2>
      </div>
      <div className="w-2/5 bg-black p-4">
        <img src="src/assets/about-me-pic.jpg"></img>
      </div>
      <p className="p-4 bg-black m-4 font-thin text-sm">
        A lifelong computer nerd, I've always been curious about what goes on inside this thing we're both looking at. My passion for all things tech led me to a career in the video games industry, where I spent 5 years in QA, learning to crunch, and working together with my team to hit tough deadlines. As a programmer, I've taken what I've learned from those years and pushed myself to create incredible things with my own code. I'm able to set and hit goals while creating products that I'm truly proud of.
      </p>
    </>
  )
}
